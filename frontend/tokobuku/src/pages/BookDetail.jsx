...
export default function BookDetail() {
  ...
  const handleDelete = async () => {
    if (window.confirm('⚠️ Yakin ingin menghapus buku ini?\nAksi ini tidak bisa dibatalkan.')) {
      try {
    ...
    <div className="container mx-auto p-4 md:p-6 max-w-4xl">
      ...
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
        <div className="p-6 md:p-8">
          ...
          <p className="text-lg text-gray-600 mb-4">oleh {book.author || 'Penulis tidak diketahui'}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-indigo-600">Rp {book.price?.toLocaleString() || '0'}</p>
            </div>
            <div>
